...
class CabinetSceneCfg(InteractiveSceneCfg):
    ...
    # camera, will be populated by agent env cfg
    camera: TiledCameraCfg = MISSING
    # camera: CameraCfg = MISSING
    # camera frame transformer, will be populated by agent env cfg
    camera_frame: FrameTransformerCfg = MISSING
    # # ray caster sensor
    # ray_caster_camera: RayCasterCameraCfg = MISSING
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        image = ObsTerm(func=mdp.rgb_image)
