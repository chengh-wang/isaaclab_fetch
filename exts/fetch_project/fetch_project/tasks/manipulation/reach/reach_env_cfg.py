...
# we should import the mdp in this task.
...
class ActionsCfg:
    ...
    base_action: ActionTerm = mdp.DifferentialDriveActionCfg(
        ...
        wheel_radius=0.0625,        # Fetch wheel radius (m)
        wheel_separation=0.372,      # Fetch track width (m)
...
class TerminationsCfg:
    ...
    robot_flipped = DoneTerm(
        ...
        params={"asset_cfg": SceneEntityCfg("robot"), "max_tilt_angle": 0.9},
    )
@configclass
class CurriculumCfg:
