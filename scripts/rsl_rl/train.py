...
from fetch_project.tasks.manipulation.reach.metrics_wrapper import KeypointMetricsWrapper
...
def main():
    ...
    # parse configuration
    env_cfg: ManagerBasedRLEnvCfg = parse_env_cfg(args_cli.task, num_envs=args_cli.num_envs, device=args_cli.device)
